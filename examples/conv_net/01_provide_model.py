...
async def main(
    model_path: str, out_path: str
) -> None:  # Use the devnet configuration generated by `nillion-devnet`
    ...
    model_secrets = model_client.export_state_as_secrets("my_nn", na.SecretRational)
    ...
    print(
        f"Stored model_provider_user_id with id: {model_provider.user_id} {type(model_provider.user_id)}"
    )
